...
export ZSH="/Users/jakubigla/.oh-my-zsh"
...
plugins=(aws direnv docker docker-compose git history history-substring-search kubectl)
...
alias bfg='docker run -it --rm --volume "$PWD":/data --workdir /data soodesune/bfg-repo-cleaner'
alias sshtunel='ssh -C2qTnNf -D 9876'
